...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: '/Newebpay/Newebpay',
        name: '藍新金流測試',
        component: () => import('@/views/Newebpay/Newebpay.vue'),
      },
      {
        path: '/Newebpay/success',
        name: 'Success',
        component: () => import('@/views/Newebpay/Success.vue'),
      },
      {
        path: '/Newebpay/failure',
        name: 'Failure',
        component: () => import('@/views/Newebpay/Failure.vue'),
      },
      {
